...
function DeleteBudgetOnEditModal({ guestMain: { budget } }) {

  useEffect(() => {
    const element = document.getElementById('deleteBudgetOnEditModal')
...
// Modal Style
  ...
  return (
    <div id="deleteBudgetOnEditModal" className="modal no-autoinit" style={modalStyle} >
...
export default connect(mapStateToProps)(DeleteBudgetOnEditModal);
